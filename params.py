...
def get_args(description='DGL on Retrieval Task'):
    ...
    parser.add_argument("--noun_loss_alpha", type=float, default=0.2)
    ...
    parser.add_argument('--shared_latent_space', type=str, default='linear', 
                        choices=['linear'])
    ...
    parser.add_argument('--Nlayers', type=int, default=12, help='number of prompt layers')
    parser.add_argument('--npev', type=int, default=10, help='for vcmr, max proposals per video')
    parser.add_argument('--max_event_per_text', type=int, default=1000, help='max event cnts per query')
    parser.add_argument('--num_adapter_layers', type=int, default=12)
    parser.add_argument('--temp_kernel_sz', type=int, default=3)
    parser.add_argument('--adapter_channels', type=int, default=384)

    parser.add_argument('--subtask_type', type=str, default='PRVR', choices=['PRVR', 'VCMR'])

    parser.add_argument('--plot_dir', type=str)
    parser.add_argument('--pyr_config_path', type=str)
    parser.add_argument('--Nf', type=int, default=32, help='number of frames')
    parser.add_argument('--Nvp', type=int, default=4, help='number of frame visual prompts (per frame)')
